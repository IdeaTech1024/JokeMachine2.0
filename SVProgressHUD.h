...
//
//
// modify by ytb 2013.7.13
// add method  + (void)showWithOnlyStatus:(NSString *)string;
//
...
@property (readwrite, nonatomic, retain) UIImage *hudNetErrorImage NS_AVAILABLE_IOS(5_0) UI_APPEARANCE_SELECTOR;
#endif
